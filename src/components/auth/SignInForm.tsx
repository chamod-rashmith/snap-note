...
export default function SignInForm({ isOpen, onClose, onSwitchToSignUp }: SignInFormProps) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
            <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md relative animate-fade-in-up">
                ...
                <p className="text-sm text-slate-500 mb-6">Sign in to access your notes</p>
